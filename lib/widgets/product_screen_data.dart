...
class ProductScreenData extends StatefulWidget {
  ...
  @override
  State<ProductScreenData> createState() => _ProductScreenDataState();
}

class _ProductScreenDataState extends State<ProductScreenData> {
  var counterValue = 0;
